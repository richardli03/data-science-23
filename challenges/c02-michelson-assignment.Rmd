...
-   Honestly, I'm not certain what observations I ought to make. It
    ...
    anything major regarding the real and simulated data. We still kind
    of see that all of the major outliers exist in the real dataset when
    looking at the temperature graph (which still checks out; the real
    world is randomly weird), but the trend is not so obvious when we
    look at Distinctness. I don't observe any major trends that would
    tell me whether or not the data belongs to the "real" family or the
    "simulated family".
