...
-   Does your interval include the true value of $\pi$?
    -   No it doesn't, unfortunately, though I suppose I wouldn't be too unhappy about missing a 90% confidence interval
...
-   Was your sample size $n$ large enough? Why do you say that?
    -   Probably not; I only picked 1000 points which, although large in isolation, is not truly that diverse for estimating something as precise as pi. It ends up estimating it to be \~3.18 which is impressively in range of the actual value of pi.
