...
-   Do thicker alloys of aluminum have higher or lower elasticity?
    -   It appears that a higher thickness results in a lower E value, which makes me think lower elasticity.
...
-   According to the the line of best fit thicker alloys appear to have lower elasticity. However, the data is spread in such way that really doesn't provide anything conclusive; not accounting for other factors like nu values and angle, it's really hard to say confidently that thickness and elasticity are related in any way.
...
-   Does this graph support or contradict the claim above?
    -   This graph appears to contradict the claim above. It's clear to see that the thickness of the material trends in some way with the elasticity of the material. For instance, the lowest elasticity is found solely in the thickest materials, and the most elastic are found solely in the thinnest.
    -   It's hard for me to say that the evidence is *conclusive*, per se, because there's a number of factors about how these numbers were determined that aren't accounted for here: for instance, elasticity is measured on a machine that could possible slip, yielding the wrong value.
