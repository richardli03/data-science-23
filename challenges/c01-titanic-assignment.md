...
- Are there any differences?
  - Yes. Wikipedia says that there were 2224 passengers and crew aboard
    the titanic, but the dataset only includes 2201 people.
- If yes, what might account for those differences?
  - These differences might come from unidentifiable bodies that didn’t
    posses the necessary categories to be included in the dataset.
...
- The number of female passengers saved far outnumbers the number of
  males saved in 1st and 2nd class, are roughly equal in 3rd and swing
  drastically in the male direction for crew. Now, raw numerical data
  like this rarely ever a helpful statistic to utilize in drawing
...
- Even with these biased datasets though, I’m tempted to draw
  ...
  more accurate look into what biases I may or may not have considered.
...
- Write your observations here.
  ...
  It appears that the *proportion* of female passengers that survived is
  much higher than the proportion of male passengers for 3rd class and
  crew, even though the previous graph would tell you nothing of the
  sort.

- Is there anything *fishy* going on in your plot?

  The whole thing reeks of salmon and tuna. Mainly, it says that over 1
  (100%) of men in first class and around 200% of the women in first
  class were rescued. That immediately strikes me as odd, because that’s
  simply impossible; there’s clearly another variable here that’s
  affecting the scale of the proportion that isn’t visualized in this
  graph.
...
First, there were no children who were crew members (or none of them
survived, but we’re simply going to assume that no children were crew
members because I want to retain some of my faith in humanity). Knowing
what I know about child labor in the early 1900s, I think that’s a
surprisingly good sign. Secondly, 100% of first and second class
*children* were saved; that make sense, given that children were ordered
onto the lifeboats before adults were able to get on them. Finally, It
appears that prioritizing children kind of went out of the window when
it came to 3rd class. It seemed like a borderline free-for-all, the way
both of the columns indicate how few people survived. I mean, the rich
*literally paid* for their (children’s) lives.

- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.

The reason why over 100% of men and women were getting saved is because
we were lumping together adults and children, thus bringing up the total
number of “men” and “women” considerably. Once we factor that out, every
percentage actually appears to be capped out at 100%, which is much more
