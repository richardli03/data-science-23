...
-   Is the bolded response **active** or **passive**? Why?
    ...
    Active: it addresses the catch and elaborates on it.

-   Is the bolded response **constructive** or **destructive**? Why?

    Constructive: it builds up the person who brought up this question, allowing them to feel like they've suggested something valuable to the conversation.

-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?

    I think the q1 interaction would've made me angry, mainly because being ignored is something that tends to frustrate me a lot. Even though my concern was addressed, the response made me feel small, which would encourage me to avoid interacting with the presenter in the future.
...
-   Is the bolded response **active** or **passive**? Why?
    ...
    Passive: the presenter acknowledges there was a mistake, but does not elaborate on the interaction.

-   Is the bolded response **constructive** or **destructive**? Why?

    Constructive: by acknowledging there was a mistake, the presenter affirms the colleague's ability and skill, even though the presenter doesn't correct the interaction.

-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?

    Honestly, quite odd. This doesn't seem like a realistic response to a concern at all, because my brain so naturally wants to answer the question that its already acknowledged.
...
-   Is the bolded response **active** or **passive**? Why?
    ...
    Passive: the colleague isn't expanding or interacting in any way with the graph itself.

-   Is the bolded response **constructive** or **destructive**? Why?

    Destructive: at least in my interpretation, this is a switch-up question designed to knock the presenter off-balance. This kind of question out of left field is a sneaky, but equally jerk-ish attack to lob at someone who's likely nervous in a presentation.
